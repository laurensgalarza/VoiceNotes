    ...
    <div className="mt-40 min-h-screen bg-white flex flex-col items-center p-6 ">       
        ...
        <div className="flex flex-col md:flex-row gap-8 w-full max-w-5xl">
            ...
            <div className="mb-4 relative"> {/* Make the container relative for absolute positioning */}
                ...
                <input type="text" value={config.gradeLevel} onChange={(e) => {setConfig({...config, gradeLevel: e.target.value})}} placeholder="ex. College Sophomore" className="w/2 px-3 py-2 border rounded-md mx-auto flex" />
            ...
            <div className="flex flex-col mb-4 items-center">
                ...
                <div className="flex">
                <button onClick={() => {setConfig({...config, storyType: "Educational"})}} className={`${config.storyType === "Educational" ? "bg-gray-800 text-white" : "bg-gray-200 text-gray-800" } px-3 py-1 rounded-md cursor-pointer`}>Educational</button>
                <button onClick={() => {setConfig({...config, storyType: "Creative"})}} className={`${config.storyType === "Creative" ? "bg-gray-800 text-white" : "bg-gray-200 text-gray-800" } px-3 py-1 rounded-md cursor-pointer`}>Creative</button>
                </div>
            </div>
            ...
            <div className="flex flex-col mb-4 items-center ">
                ...
                <div className="flex">
                <button onClick={() => {setConfig({...config, narration: "first person"})}} className={`${config.narration === "first person" ? "bg-gray-800 text-white" : "bg-gray-200 text-gray-800" } px-3 py-1 rounded-md cursor-pointer`}>First Person</button>
                <button onClick={() => {setConfig({...config, narration: "third person"})}} className={`${config.narration === "third person" ? "bg-gray-800 text-white" : "bg-gray-200 text-gray-800" } px-3 py-1 rounded-md cursor-pointer`}>Third Person</button>
                </div>
            </div>
